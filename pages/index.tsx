...
import { useCurrentUserQuery, useLogoutMutation } from "../src/generated/graphql";

export default function Home() {
  const [{ data, error, fetching, stale }] = useCurrentUserQuery();
  ...
  return (
    <div className="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          <a
            className="cursor-pointer flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-gray-200"
            href="#"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            className="cursor-pointer flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
            onClick={()=>{logout()}}
          >
            <svg
              className="w-5 h-5"
