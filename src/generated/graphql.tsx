...
export type CurrentUserQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserResponse', user?: Maybe<{ __typename?: 'User', id: number, name: string, email: string }>, errors?: Maybe<Array<{ __typename?: 'FieldError', message: string }>> } };
